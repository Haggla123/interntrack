...
const seed = async () => {
  ...
  const [kwame, abena, kofi, pending] = await User.create([
    { name:'Kwame Mensah',  email:'kwame@st.uenr.edu.gh', password:seedPasswords.student, role:'student', indexNumber:'UEB3214522', department:'Computer Science',       status:'Placed', companyId:mtn._id, companyName:'MTN Ghana',                    placementStatus:'Active', placementStartDate:new Date('2025-02-01'), academicSupervisor:drFrimpong._id, industrialSupervisor:mtnSup._id, needsPasswordChange:true },
    { name:'Abena Serwaa',  email:'abena@st.uenr.edu.gh', password:seedPasswords.student, role:'student', indexNumber:'UEB3214523', department:'ITDS',                   status:'Placed', companyId:mtn._id, companyName:'MTN Ghana',                    placementStatus:'Active', placementStartDate:new Date('2025-02-08'), academicSupervisor:drFrimpong._id, industrialSupervisor:mtnSup._id, needsPasswordChange:true },
    { name:'Kofi Asante',   email:'kofi@st.uenr.edu.gh',  password:seedPasswords.student, role:'student', indexNumber:'UEB3214524', department:'Computer Science',       status:'Graded', companyId:ecg._id, companyName:'Electricity Company of Ghana', placementStatus:'Active', placementStartDate:new Date('2025-01-20'), academicSupervisor:drAmoah._id,    industrialSupervisor:ecgSup._id, needsPasswordChange:true },
